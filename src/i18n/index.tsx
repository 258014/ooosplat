...
const zhCN = {
  ...
  "update.installFailed": "更新失败，重试",
  "update.waitsForTask": "任务完成后可更新",
  "update.installBlockedHint": "任务运行中不会安装更新，以免中断正在进行的处理",
  "update.pausedForTask": "任务运行中，已暂停安装；任务结束后可再次更新",
  "update.startBlockedByDownload": "更新下载完成后可开始",
  ...
  "progress.registered": "已注册 {current}/{total}",
  ...
  "reshoot.importTitle": "导入高清补拍素材",
  "reshoot.importHint": "补拍素材会复制到新的派生项目，与原始输入画面融合后重新运行 COLMAP 和 Brush。原项目及其 final.ply 不会被覆盖。",
  "reshoot.chooseVideo": "选择补拍视频",
  ...
  "reshoot.kindBox": "盒选",
  "reshoot.generatingGuide": "正在生成指引图",
  "reshoot.addCurrent": "加入当前区域",
  "reshoot.region": "区域 {index}",
  "reshoot.remove": "移除",
  "reshoot.removeAria": "移除补拍区域 {index}",
  "reshoot.viewGuideTitle": "在新标签页查看指引图",
  "reshoot.guideImageAlt": "区域 {index} 补拍方位指引",
  "reshoot.arrowLegend": "箭头 = 补拍机位，指向该区域",
  "reshoot.generatingDirection": "正在生成方位指引图",
  "reshoot.missingGuide": "未生成指引图",
  "reshoot.errorSelectFirst": "请先使用“球选择”或“盒选择”圈出模糊区域。",
  "reshoot.errorDuplicate": "该区域已在补拍清单中。请调整选择范围或移动相机后再加入，避免重复补拍同一区域。",
  "reshoot.errorNoFrame": "无法获取当前视角的画面。",
  "reshoot.errorNoGuide": "无法生成补拍指引图。",
  "reshoot.errorGuideFailed": "区域 {index} 的指引图生成失败：{detail}",
  "reshoot.errorEmpty": "请至少添加一个需要补拍的区域。",
  "reshoot.geometryCenter": "中心 ({values})",
  "reshoot.geometrySphere": "球选 · {center} · 半径 {radius}",
  "reshoot.geometryBox": "盒选 · {center} · 尺寸 ({size})",
  "reshoot.guidanceSphere": "区域 {index}｜{geometry}｜绕该区域缓慢环拍两周：第一周低角度、第二周抬高约 30°，每圈至少 12 个机位，始终让该区域位于画面中央并保留前景与背景两层视差。",
  "reshoot.guidanceBox": "区域 {index}｜{geometry}｜从正面、左侧、右侧与上方各补拍一组高清画面，相邻机位间隔约 30°；避免仅原地变焦或只沿一个方向平移。",
  "reshoot.caption": "区域 {index} · {kind} · 箭头 = 补拍机位（箭头指向被补拍区域）",
  "reshoot.dirFrontLow": "正前低角度",
  "reshoot.dirFrontRightLow": "右前低角度",
  "reshoot.dirRightLow": "右侧低角度",
  "reshoot.dirBackRightLow": "右后低角度",
  "reshoot.dirBackLow": "正后低角度",
  "reshoot.dirBackLeftLow": "左后低角度",
  "reshoot.dirLeftLow": "左侧低角度",
  "reshoot.dirFrontLeftLow": "左前低角度",
  "reshoot.dirFrontRaised": "正前抬高 30°",
  "reshoot.dirRightRaised": "右侧抬高 30°",
  "reshoot.dirBackRaised": "正后抬高 30°",
  "reshoot.dirLeftRaised": "左侧抬高 30°",
  "reshoot.dirFront": "正面",
  "reshoot.dirLeft": "左侧",
  "reshoot.dirRight": "右侧",
  "reshoot.dirFrontRight": "右前 30°",
  "reshoot.dirFrontLeft": "左前 30°",
  "result.title": "生成结果",
  "result.completed": "已完成",
  "result.splats": "Splat 数量",
  "result.fileSize": "PLY 大小",
  "result.registered": "注册图像",
  "result.points": "三维点",
  "result.elapsed": "总耗时",
  "result.lowRegistration": "注册率 {value}%，低于 80%，结果质量可能受到影响",
  "result.export": "导出 PLY",
  "result.reveal": "在文件管理器中显示",
  "status.running": "处理中",
  ...
  "error.openFolder": "未能打开文件夹，请重试：{detail}",
  "error.timeout": "等待系统响应超时",
  "error.previewCleanupTimeout": "预览清理时间较长，界面已恢复；后台会继续释放资源。",
  "failure.mapperTitle": "无法从素材中还原拍摄空间",
  "failure.mapperSource": "不同画面之间没有找到足够的联系。常见原因是拍摄移动太快、画面模糊、相邻画面重叠太少，或场景中有太多移动物体。",
  ...
  "failure.mapperTip3": "避开模糊、纯色、反光画面和大量移动的人或物体。",
  "failure.storageTip1": "确认项目磁盘仍然连接，并留有足够空间。",
  "failure.storageTip2": "关闭可能正在占用项目文件的同步、清理或安全软件后重试。",
  "failure.brushTip1": "关闭游戏、渲染和其他占用显卡的程序。",
  "failure.brushTip2": "更新显卡驱动并重启电脑，然后继续任务。",
  ...
  "failure.logsUnavailable": "该任务还没有可打开的日志目录。",
  ...
  "panel.invalidRange": "请输入 {min} 到 {max} 之间的数值",
  "animation.reveal": "显现",
...
const en: Record<TranslationKey, string> = {
  ...
  "error.openFolder": "Could not open the folder. Please retry: {detail}",
  "error.timeout": "The system took too long to respond",
  "error.previewCleanupTimeout": "Preview cleanup is taking longer than expected. The interface has recovered and cleanup will continue in the background.",
  "failure.mapperTitle": "The app could not rebuild the captured space",
  "failure.mapperSource": "The app could not find enough connection between the images. This often happens when the camera moves too quickly, frames are blurry, neighboring views overlap too little, or too many objects are moving.",
  ...
  "failure.mapperTip3": "Avoid blurry, blank, reflective views and scenes with many moving people or objects.",
  "failure.storageTip1": "Make sure the project drive is connected and has enough free space.",
  "failure.storageTip2": "Close sync, cleanup, or security apps that may be using the project files, then retry.",
  "failure.brushTip1": "Close games, rendering tools, and other apps using the graphics card.",
  "failure.brushTip2": "Update the graphics driver, restart the computer, and resume the task.",
  ...
  "failure.logsUnavailable": "This task does not have a log folder yet.",
